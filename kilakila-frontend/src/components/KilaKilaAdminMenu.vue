  ...
  <div class="admin-menu">
    ...
    <el-menu>
      ...
      <el-menu-item index="2" @click="$router.push('/archive')">
        <font-awesome-icon :icon="['fas', 'box-archive']" class="menu-icon" />
        <span>归档</span>
      </el-menu-item>
      ...
      <el-sub-menu index="3">
        <template #title>
          <font-awesome-icon :icon="['fas', 'folder']" class="menu-icon" />
          <span>分类</span>
        </template>
        <el-menu-item
      ...
      <el-sub-menu index="4">
        <template #title>
          <font-awesome-icon :icon="['fas', 'tags']" class="menu-icon" />
          <span>标签</span>
        </template>
        <el-menu-item
